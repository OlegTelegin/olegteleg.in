...
% analysis due to the computational complexity of accumulating enough
% observations in 1 run. 
...
% observation won't be written). Alternatively, you can set n_outerrun to a
% smaller number.
...
% a mediocre laptop with i7proc/16GB RAM can calculate around 
% 15-20 observations per hour.
